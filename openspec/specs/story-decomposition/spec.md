...
Breaks an OpenSpec change (proposal, design, specs, tasks) into fully-specified stories, each implementable by an agent with zero assumptions, at most 3 acceptance criteria, and explicit dependency lists.
