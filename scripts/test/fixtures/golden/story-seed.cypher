...
MERGE (c:Change {name: "fixture-change"});

MERGE (s:Story {id: "scaffold", change: "fixture-change"})
...
MATCH (c:Change {name: "fixture-change"}),
      (s:Story {id: "scaffold", change: "fixture-change"})
MERGE (c)-[:HAS_STORY]->(s);

MERGE (s:Story {id: "core", change: "fixture-change"})
...
MATCH (c:Change {name: "fixture-change"}),
      (s:Story {id: "core", change: "fixture-change"})
MERGE (c)-[:HAS_STORY]->(s);

MATCH (a:Story {id: "core", change: "fixture-change"})
MATCH (b:Story {id: "scaffold", change: "fixture-change"})
